...
return {
	...
	offset: function (el) {
		...
		/*	
		  ##### COMMENTED OUT. THIS DOESN'T WORK UNDER SHADOW DOM IN IE ######
		...
		*/
		...
		/* #################### PATCH ###############################
		*  #  This patch enables highcharts to work properly under  #
		*  # shadow dom in IE ... and it works!  
		*  # Thanks to this conversation: https://groups.google.com/forum/#!topic/polymer-dev/ul5PQo8bS_U 
		*  # Refering to this github: https://github.com/ileonte/polymer-chart-test
		*  #                                                        #
		*  #              ┏(-_-)┛┗(-_-﻿ )┓┗(-_-)┛┏(-_-)┓                                                 #
		*  #                                                        #
		*  ##########################################################
